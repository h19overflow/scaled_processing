...
from src.backend.doc_processing_system.pipelines.document_processing.utils.table_line_item_extractor import TableLineItemExtractor
...
def test_extract_tables_from_content_list_and_save_csv(tmp_path):
    ...
    content_list = [
        ...
        {"page_idx": 0, "type": "table", "table_body": "<table><tr><th>Item</th><th>Qty</th></tr><tr><td>Pen</td><td>3</td></tr></table>"}
    ]
