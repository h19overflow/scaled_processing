...
def invoice_extraction() -> Tuple[str, List[lx.data.ExampleData]]:
    ...
    examples = [
        # Example A: NEM-only bill (demonstrates current_charges_nem and empty current_charges)
        lx.data.ExampleData(
            text="""
ALAMAT POS
...
""",
        ...
        # Example B: Regular bill with current_charges (no NEM)
        lx.data.ExampleData(
            text="""
ALAMAT POS
