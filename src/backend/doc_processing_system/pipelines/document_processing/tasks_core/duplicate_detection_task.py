...
from src.backend.doc_processing_system.core_deps.database.CRUD.document_crud import (
    DocumentCRUD,
)
...
def duplicate_detection_task(raw_file_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        is_duplicate, existing_doc_id = document_crud.check_duplicate_by_raw_file(
            str(raw_path)
        )
