...
# # Conditional weave import to avoid initialization delays
# try:
#     import weave
#     WEAVE_AVAILABLE = True
#     # Only initialize if explicitly requested via environment variable
#     import os
#     if os.getenv("ENABLE_WEAVE_TRACKING", "false").lower() == "true":
#         weave.init(project_name="scaled_processing")
#     else:
#         # Create a dummy decorator when weave is disabled
#         def dummy_op():
#             def decorator(func):
#                 return func
#             return decorator
...
#     # Create dummy weave.op decorator
#     class DummyWeave:
#         @staticmethod
#         def op():
#             def decorator(func):
